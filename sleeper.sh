...
#Удаление префикса "NAME=" из информации 
# об операционной системе и вывод в консоль #cleaned_os_info=$(echo 
# "$os_info" | sed 's/NAME=//')
